    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          ...
          <AdBanner position="contact-form" className="mt-8" />
        </div>
        ...
        <div>
          ...
          <div className="mt-8">
            ...
            <p className="mb-4">
              Interested in advertising on Campus Guide Nigeria? We offer various ad placement options to help you reach
              Nigerian students.
            </p>
